...
USERNAME = "shurandaa"
# Set True to show the GitHub Stats card next to Tech Stack (refreshed daily by Actions).
SHOW_STATS = False
NAME = "Shuran Zhao"
...
def readme(ctas):
    ...
    if SHOW_STATS:
        ...
        skills_row = f'<img src="assets/skills.svg" width="100%" alt="{esc(skills_alt)}" />'
        footer = ""
...
def main():
    ...
    files = {
        ...
        "mascot.svg": mascot(),
        "skills.svg": skills(wide=not SHOW_STATS),
        "metrics.svg": metrics(),
