...
<a href="https://github.com/shurandaa?tab=repositories"><img src="assets/project-ai-oncall.svg" width="100%" alt="AI On-Call · Incident Investigation Platform — LLM agents that triage alerts, correlate logs &amp; metrics, and draft root-cause reports. (Python, LangChain, AWS Bedrock, RAG, MCP)" /></a>
